...
void score(char *p){int z; z=strcmp(p,p3); if(z==0){scores[0]+=1; return; } z=strcmp(p,p4); if(z==0){scores[1]+=1; return; }  }
...
int main(int argc, const char * argv[]) {
    ...
    int i=0,count=0,j=0;    if(argc==2){ fprintf(f,"%s,%d\n%s,%d\nDraw,%d\n",p3,scores[0],p4,scores[1],scores[2] ); fclose(f);
